...
/**
 * King piece. King remains the same and won't swap roles
 *
    ...
    private boolean isNextToOppsKing(Position p) throws IOException {
        ...
        for (Position i : temp) {
            if (i != null && i.isOccupied() && i.getPiece() instanceof King
                ...
                System.out.println("Position is next to the opponent king" + i.toString() + ": " + i.getPiece().toString());
                return true;
            }
        }
        return false;
